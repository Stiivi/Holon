...
public class EdgeConstraint: Constraint {
    ...
    public func check(_ graph: GraphProtocol) -> ConstraintCheckResult {
        ...
        if violating.isEmpty {
            ...
            return ConstraintCheckResult.failure(nodes: [], edges: violating)
        }
    }
}
...
public protocol EdgeConstraintRequirement {
    ...
    ///
    func check(graph: GraphProtocol, edges: [Edge]) -> [EdgeID]
}
...
public class EdgeLabelsRequirement: EdgeConstraintRequirement {
    ...
    public func check(graph: GraphProtocol, edges: [Edge]) -> [EdgeID] {
        var violations: [EdgeID] = []
        
        for edge in edges {
            if let predicate = originLabels {
