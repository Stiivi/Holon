...
//    case unsetAttribute(Object, AttributeKey)
    ...
    public func isRelated(_ object: Object) -> Bool {
        ...
        case let .addEdge(edge): return edge === object || edge.origin == object.id || edge.target == object.id
        case let .removeEdge(edge): return edge === object || edge.origin == object.id || edge.target == object.id
