...
///
public typealias ObjectID = Object.ID

/// ID of an edge. Use rather this type alias than ObjectID.
///
public typealias EdgeID = ObjectID

/// ID of a node. Use rather this type alias than ObjectID.
///
public typealias NodeID = ObjectID

@available(*, renamed: "ObjectID")
